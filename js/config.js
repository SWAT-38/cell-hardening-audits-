...
const LOCATION_OPTIONS = [
  ...
  'Gap Conveyor 4',
  'Switch Conveyor',
  'DRVW 1 Accumulation Conveyor 1',
  'DRVW 1 Accumulation Conveyor 2',
  'DRVW 1 Accumulation Conveyor 3',
  'DRVW 1 Accumulation Conveyor 4',
  'DRVW 1 Centering Entry Conveyor',
  'DRVW 1 Centering Conveyor',
  'DRVW 1 CIS Conveyor',
  'DRVW 1 Checkweigher Conveyor',
  'DRVW 1 Data Accumulation Conveyor 1',
  'DRVW 1 Data Accumulation Conveyor 2',
  'DRVW 1 Case Turner Entry Conveyor',
  'DRVW 1 Case Turner Conveyor',
  'DRVW 1 Accumulation Conveyor 3',
  'DRVW 1 Half Snugger Conveyor',
  'DRVW 1 Staging Conveyor 1',
  'DRVW 1 Staging Conveyor 2',
  'DRVW 1 Reject Accumulation Conveyor 1',
  'DRVW 1 Reject Accumulation Conveyor 2',
  'DRVW 1 Reject Accumulation Conveyor 3',
  'Reject Conveyor',
